      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[80%] mx-auto items-center gap-[3rem] mt-[4rem] text-white">
        <div>
          <div className="bg-red-700 hover:scale-110 transform transition-all duration-300 hover:-rotate-6 uppercase font-semibold text-center p-[2rem]">
            ...
            <p className="text-[15px] text-[#d3d2d2] font-normal">
              Offering custom frontend solutions, specializing in React, Vue.js,
              and Angular, to elevate online presence with captivating user
              experiences.
            </p>
          </div>
        </div>
        <div>
          <div className="bg-orange-700 hover:scale-110 transform transition-all duration-300 uppercase font-semibold text-center p-[2rem]">
            ...
            <p className="text-[15px] text-[#d3d2d2] font-normal">
              Providing backend solutions with Node.js, Express, and MongoDB to
        ...
        <div>
          <div className="bg-blue-700 hover:scale-110 transform transition-all duration-300 hover:rotate-6 uppercase font-semibold text-center p-[2rem]">
            ...
            <p className="text-[15px] text-[#d3d2d2] font-normal">
              Offering full-stack development services with MERN stack to create
